  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: customAppBar(context,
            title: "Home",
            trailIcon: AuthViewModel.instance.user!.role == "student"
                ? GestureDetector(
                    onTap: () {
                ...
                : null,
            leadIcon: AuthViewModel.instance.user!.role == "student"
                ? const SizedBox()
                : null),
        body: Container(
          color: Colors.white,
                            ...
                            children: [
                              Text(
                                user != null
                                    ...
                                    : "${AuthViewModel.instance.user!.firstName} ${AuthViewModel.instance.user!.lastName}",
                              ...
                              StreamBuilder(
                                stream: firestore
                                    ...
                                    .doc(user != null
                                        ? user!.uid!
                                        : AuthViewModel.instance.user!.uid!)
                                    .snapshots(),
                                  ...
                                  if (snapshot.hasData) {
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "${user["level"]} level, ${user["semester"]} semester",
                                          style: const TextStyle(
                                            color: Colors.grey,
                                            fontSize: 16.0,
                                          ),
        ...
        floatingActionButton: AuthViewModel.instance.user!.role == "student"
